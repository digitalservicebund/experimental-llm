variable "region" {
  type        = string
  description = "STACKIT region for production infrastructure."
  default     = "eu01"
}

variable "project_id" {
  type        = string
  description = "STACKIT project ID that owns the production resources."
}
...
variable "vm_name" {
  type        = string
  description = "Logical name for the production VM."
  default     = "llm-gateway-prod"
}
